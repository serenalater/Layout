        ...
        <nav class="navbar navbar-expand-lg fixed-top bg-transparent" id="navbar">
            <div class="container-fluid">
                <div class="container m-auto d-flex">
                    <div>
                        <a id="logobianco" class="navbar-brand logo" href="index.php"><img src="./img/logo-bianco.png" class="navbar-brand logo" alt=""></a>
                        <a id="logonero" class="navbar-brand logo d-none" href="index.php"><img src="./img/logo-nero.png" class="navbar-brand logo" alt=""></a>
